...
const procesos = ref(props.procesos);
const estandar = ref(props.estandar);
...
const form = useForm({
    ...
    // proceso_id: procedimiento.value.proceso_id,
    procedimiento_id: estandar.value.procedimiento_id,
    nombre: estandar.value.nombre,
    descripcion: estandar.value.descripcion,
    link_externo: estandar.value.link_externo,
});
...
onMounted(() => {
    ...
    getProcedimientos(procedimiento.value.proceso_id);
});
...
const submit = () => {
    try {
        form.patch(route("estandar.update", estandar.value.id), {
            onFinish: () => {
    ...
    <Layout>
        ...
        <div class="overflow-hidden sm:rounded-lg">
            ...
            <div class="breadcrumbs flex">
                ...
                <Link
                    :href="route('estandar.edit', estandar.id)"
                    class="active"
                >
                    <h3>Editar</h3>
                </Link>
