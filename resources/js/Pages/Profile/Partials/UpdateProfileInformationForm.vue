...
<template>
    <FormSection @submitted="updateProfileInformation">
        <template #title> Información sobre el perfil </template>
        ...
        <template #actions>
            ...
            <PrimaryButton class="me-3 pi pi-save" :class="{ 'opacity-25': form.processing }"
                :disabled="form.processing">

            </PrimaryButton>

            <PrimaryButton :href="route('hello')" class="me-3 pi pi-check-square"
